...
const WorkInfo = () => {
    return ( 
        <div class="content-wrapper">
            <section className="form-wrapper work-page-wrapper">
                ...
                <form id="work-form">
                    ...
                    <div className="input-group">
                        ...
                        <textarea id="phyisical-meetings" class="textarea"></textarea>
                    </div>
                    <div className="input-group">
                        <h3>რას ფიქრობ არსებულ გარემოზე:<br /> რა მოგწონს, რას დაამატებდი, რას შეცვლიდი?</h3>
                        <textarea id="current-envorinment" class="textarea"></textarea>
                    </div>
            ...
            <aside class="img-wrapper work-page-img-wrapper">
                <img src={bike} alt="" />
            </aside>
        </div>
     );
